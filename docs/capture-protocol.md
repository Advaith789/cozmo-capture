...
| | Instead |
|---|---|
| **Point straight at a mirror** | Approach at 30–45°. Keep it under a third of the frame. |
...
|---|---|---|---|---|---|
| **A · Photos** | iPhone 15 / 15 Plus and newer | Native Camera | 6–8 JPEG per room + connector shots. No depth, no poses. | inferred | *pending* |
...
- [ ] Time processing and export separately on the next run — § 7's 20–30 minute
...
**Sessions capped at 6–8 minutes with an overlap room.** Automatic pose
