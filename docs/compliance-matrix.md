...
| 1.2 | Name the off-the-shelf tool | [docs/capture-protocol.md](capture-protocol.md) §0, §3–5 | Polycam (Tier C), native iOS Camera (Tiers A/B) | **done** |
| 1.3 | One-page protocol a non-engineer follows | [docs/capture-protocol.md](capture-protocol.md) | prints to one A4 page | **done** |
| 1.4 | What to install / how to walk / how long / what to avoid / how to hand files over | §0, §1, §3–7 | numbered steps, all distances and durations stated | **done** |
...
| # | Requirement | File | Artifact | Status |
|---|---|---|---|---|
| 1.7 | Tier A — photos, 2–8 stills per room | [src/cozmo/ingest/](../src/cozmo/ingest/) | captured for 3 rooms; **ingest not implemented** | **not done** |
